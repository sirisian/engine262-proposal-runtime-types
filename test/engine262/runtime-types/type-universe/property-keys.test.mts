...
// Spec: #sec-existing-abstract-conversion-operations (The Existing Abstract
// Conversion Operations) - typed-number property keys. The proposal does not
// override ToPropertyKey, so a typed number keys by its numeric string,
// exactly as BigInt does: value distinctness (=== / SameValue) and

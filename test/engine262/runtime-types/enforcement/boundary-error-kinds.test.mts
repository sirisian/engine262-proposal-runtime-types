...
/**
 * Spec: #sec-the-boundary-check (The Boundary Check) - the error kinds.
 *
 * Which error a refused boundary reports: a value of a numeric type the target
 * cannot represent exactly is a RangeError, and a value with no conversion to
 * the target at all is a TypeError.
 */

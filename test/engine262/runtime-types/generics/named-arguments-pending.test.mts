// What remains of named type arguments, pinned as `test.fails` so a silent fix
// or a regression is equally loud. Each flips to `test` when it closes.
//
// A POSITIONAL short argument list in type position keeps its
...
// binder unification, where displayType learns the canonical form at the same
// time.
